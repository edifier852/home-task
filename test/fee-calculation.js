...
import { startFeesCalculation } from '../src/fee-calculation.js';


it('startFeesCalculation', () => {
    ...
    startFeesCalculation(inputOperations)

    const results = console.log.mock.calls.map((call) => call.arguments).flat();
    assert.deepStrictEqual(results, ['0.06', '0.90', '87.00', '3.00', '0.30', '0.30', '5.00', '0.00', '0.00'])
});